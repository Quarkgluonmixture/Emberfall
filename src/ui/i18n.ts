...
const UI: Record<string, { en: string; zh: string }> = {
  ...
  // Saga / Full toggle: Saga shows only the epochal spine, Full the chronicle.
  'history.saga': { en: 'Saga', zh: '史诗' },
  'history.full': { en: 'Full record', zh: '全记录' },
  // Aggregated lines when one kind repeats within a year (keeps it a saga,
  // not a ledger). Only the kinds that plausibly recur often need one.
  'history.agg.town': { en: '{n} towns rose', zh: '{n} 座城镇兴起' },
  'history.agg.collapse': { en: '{n} settlements fell to ruin', zh: '{n} 处聚落沦为废墟' },
  'history.agg.warDeclared': { en: '{n} wars broke out', zh: '{n} 场战争爆发' },
  'history.agg.treatySigned': { en: '{n} treaties were signed', zh: '{n} 纸和约缔结' },
  'history.agg.peace': { en: '{n} peaces were made', zh: '{n} 次议和' },
  'history.agg.rivalry': { en: '{n} rivalries took root', zh: '{n} 段宿怨结下' },
  'history.agg.succession': { en: '{n} succession crises', zh: '{n} 场继承危机' },
  'history.agg.schism': { en: '{n} schisms tore the faiths', zh: '{n} 次教派分裂' },
  'history.agg.wildfire': { en: '{n} wildfires raged', zh: '{n} 场野火肆虐' },
  'history.agg.capture': { en: '{n} towns were taken', zh: '{n} 座城镇易主' },
